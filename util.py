...
def format_license(text):
    ...
    elif (text[5] == ' ') and (len(text)==9):
        mapping = { 0: dict_char_to_int, 1: dict_char_to_int, 
                3: dict_int_to_char, 4: dict_int_to_char, 
                6: dict_char_to_int, 7: dict_char_to_int, 8: dict_char_to_int}
        
        license_plate_ = ''
    
        for j in [0, 1, 3, 4, 6, 7, 8]:
            if text[j] in mapping[j].keys():
                license_plate_ += mapping[j][text[j]]
            else:
                license_plate_ += text[j]
    ...
    elif (text[6] == ' ') and (len(text)==9):
        mapping = { 0: dict_char_to_int, 1: dict_char_to_int, 
                3: dict_int_to_char, 4: dict_int_to_char, 
                5: dict_int_to_char, 7: dict_char_to_int, 8: dict_char_to_int}
    ...
    elif (text[6] == ' ') and (len(text)==10):
        mapping = { 0: dict_char_to_int, 1: dict_char_to_int, 
                3: dict_int_to_char, 4: dict_int_to_char, 
                5: dict_int_to_char, 7: dict_char_to_int, 8: dict_char_to_int, 9: dict_char_to_int}
     
        license_plate_ = ''
    
        for j in [0, 1, 3, 4, 5, 7, 8, 9]:
            if text[j] in mapping[j].keys():
                license_plate_ += mapping[j][text[j]]
            else:
                license_plate_ += text[j]
...
def read_plate_debug_unfiltered(license_plate_crop):
